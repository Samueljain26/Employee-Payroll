...
public class EmployeePayrollExceptionHandler {
    @ExceptionHandler(com.bridgelabz.employee_payroll.exception.EmployeePayrollException.class)
    public ResponseEntity<ResponseDTO> handleEmployeePayrollException(com.bridgelabz.employee_payroll.exception.EmployeePayrollException exception) {
